  ...
  return (
    <>
      <AntHeader className={styles.header}>
        ...
        <Space size="middle">
          <Tooltip title={t("header.changelog")} style={{ display: 'none' }}>
            <Button
              type="text"
          ...
          <Tooltip title={t("header.docs")} style={{ display: 'none' }}>
            <Button
              type="text"
          ...
          <Tooltip title={t("header.faq")} style={{ display: 'none' }}>
            <Button
              type="text"
          ...
          <Tooltip title={t("header.github")} style={{ display: 'none' }}>
            <Button type="text" onClick={() => handleNavClick(GITHUB_URL)} style={{ display: 'none' }}>
              {t("header.github")}
            </Button>
          </Tooltip>
